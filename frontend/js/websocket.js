(function () {
  ...
  class LibertyGateway {
    ...
    _createPeer(targetId) {
      ...
      pc.oniceconnectionstatechange = function () {
        if (pc.iceConnectionState === 'failed' || pc.iceConnectionState === 'disconnected' || pc.iceConnectionState === 'closed') {
          try { self.endCall(targetId); } catch (_) {}
    ...
    initiateCall(targetId, options) {
      console.log('[Gateway] initiateCall DESATIVADO - use call-system.js');
      return Promise.reject(new Error('Use call-system.js'));
      /*
      var self = this;
    ...
    // DESATIVADO: call-system.js gerencia todas as chamadas
    acceptCall(targetId) {
      console.log('[Gateway] acceptCall DESATIVADO - use call-system.js');
      return Promise.reject(new Error('Use call-system.js'));
      /*
      var self = this;
      targetId = String(targetId);
    ...
    // DESATIVADO: call-system.js gerencia todas as chamadas
    endCall(targetId) {
      console.log('[Gateway] endCall DESATIVADO - use call-system.js');
      return;
      /*
      targetId = String(targetId);
      var entry = this.peers.get(targetId);
    ...
    // DESATIVADO: call-system.js gerencia todas as chamadas
    rejectCall(targetId) {
      console.log('[Gateway] rejectCall DESATIVADO - use call-system.js');
      return;
      /*
      targetId = String(targetId);
