...
class LibertyApp {
    ...
    setupEventListeners() {
        ...
        // Forgot password link (auth screen)
        document.querySelector('#login-form a[href="#"]')?.addEventListener('click', e => {
            e.preventDefault();
            this.showToast('Password reset — use the email we sent you or contact support.', 'info');
        });
